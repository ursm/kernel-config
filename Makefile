...
GENERATED := 00-net-vendors-off.config 00-wlan-vendors-off.config 00-usbnet-off.config 00-drm-off.config 00-fs-off.config 00-part-off.config 00-media-off.config 00-scsi-off.config 00-iio-off.config 00-netfs-off.config 00-pata-off.config 00-sata-off.config 00-alsa-pci-legacy-off.config 00-joy-legacy-off.config 00-nfc-off.config 00-staging-off.config 00-9p-rxrpc-off.config 00-ceph-lib-off.config 00-intel-smartconnect-off.config
